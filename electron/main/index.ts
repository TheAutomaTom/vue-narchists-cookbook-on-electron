import electron, { app, BrowserWindow, shell, ipcMain, MenuItem, Menu } from 'electron';
import { release } from 'node:os';
import { join } from 'node:path';
import { menuTemplate as appMenuTemplate } from './appMenu';
...
app.whenReady().then(function(){
  ...
  contextMenuItems.forEach(entry => {
